    ...
    <Card className="border-muted-foreground/20 bg-muted/30 border-dashed shadow-none">
      <CardHeader className="flex flex-row items-start gap-4">
        ...
        <div className="flex-1 space-y-1.5">
          ...
          <CardDescription className="text-xs sm:text-sm">{detail}</CardDescription>
        </div>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <div className="from-background to-muted/50 flex items-center gap-3 rounded-none border bg-gradient-to-br p-4 shadow-sm">
        ...
        <div className="flex-1 space-y-1">
          ...
          <p className="text-muted-foreground text-sm">
            Kleines Skeleton, das die Dialog-Komponente nutzt, um künftige Cursor-Styles zu
            skizzieren.
          </p>
        </div>
        <DialogTrigger>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Placeholder-Dialog mit Skeleton-Karten. Später können hier echte Presets und
            Live-Previews landen.
          </DialogDescription>
        </DialogHeader>
