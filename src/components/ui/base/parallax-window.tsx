...
function ParallaxWindow() {
  return (
    <div className="relative z-0 block h-[800px]">
      ...
      <div className="absolute block h-[900px] w-full bg-[url('/keyart/layer-6.png')] bg-[length:auto_700px] bg-bottom bg-center bg-repeat-x" />
    </div>
  );
}
