    ...
    <>
      <Tooltip delay={500}>
        <TooltipTrigger
          ...
          className="focus-visible:ring-ring relative inline-flex items-center justify-center rounded-md p-3 transition-colors hover:bg-white/10 focus-visible:ring-1 focus-visible:outline-none"
